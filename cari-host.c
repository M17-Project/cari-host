...
void print_help(const char *program_name) {
	...
	printf("  -p, --pa=PIN          PA_EN GPIO pin number (integer)\n");
	printf("  -n, --nrst=PIN        /RST GPIO pin number (integer)\n");
	printf("  -b, --boot=PIN        BOOT0 GPIO pin number (integer)\n");
	printf("  -d, --dl=PORT         Baseband downlink port number (integer)\n");
	printf("  -c, --ctrl=PORT       Control port number (integer)\n");
	printf("  -D, --device=PATH     UART device (string)\n");
	printf("  -S, --speed=BAUD      UART baudrate (integer)\n");
	printf("\n");
	printf("Optional options:\n");
	printf("  -m, --me=PORT         Supervision (telemetry) channel downlink port number (integer)\n");
	printf("  -r, --reset           Reset the device and exit\n");
